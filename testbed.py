...
env.openstack_admin_password = 'password123'
...
# service_dbpass: Default = 'password123'; DB password of all openstack service users
#
#env.openstack = {
...
#    'service_dbpass' : 'password123',         #DB password of all openstack service users
#}
